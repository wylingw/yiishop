...
<div class="main w1210 bc mt10">
    ...
    <div class="address_bd mt10">
        <h4>新增收货地址</h4>
        <form action="<?= \yii\helpers\Url::to(['address/add']) ?>" method="post" name="address_form" id="signupForm">
            <ul>
                <li>
                ...
                <li>
                    ...
                    <select value="" id="cmbProvince" name="cmbProvince"></select>
                    <select value="" id="cmbCity" name="cmbCity"></select>
                    <select value="" id="cmbArea" name="cmbArea"></select>
                </li>
                <li>
                    <label for=""><span>*</span>详细地址：</label>
                    <input type="text" name="address" class="txt" value="">
