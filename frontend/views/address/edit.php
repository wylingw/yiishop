...
<div class="main w1210 bc mt10">
    ...
    <div class="address_bd mt10">
        <h4>修改收货地址</h4>
        <form action="<?= \yii\helpers\Url::to(['address/edit','id'=>$model->id]) ?>" method="post" name="address_form" id="signupForm">
            <ul>
                <li>
                    <label for=""><span>*</span>收 货 人：</label>
                    <input type="text" name="name" class="txt" value="<?= $model->name ?>"/>
                    <input type="hidden" name="id" class="txt" value="<?= $model->id ?>"/>
                </li>
                <li>
                    <label for=""><span>*</span>所在地区：</label>
                    <script type="text/javascript" src="/js/address.js"></script>
                    <select value="<?= $model->cmbProvince?'selected':'' ?>" id="cmbProvince"
                            name="cmbProvince"></select>
                    <select value="<?= $model->cmbCity ?>" id="cmbCity" name="cmbCity"></select>
                    <select value="<?= $model->cmbArea ?>" id="cmbArea" name="cmbArea"></select>
                </li>
                <li>
                    <label for=""><span>*</span>详细地址：</label>
                    <input type="text" name="address" class="txt" value="<?= $model->address ?>">
                ...
                <li>
                    <label for="">&nbsp;</label>
                    <input type="checkbox" name="is_selected" class="check"/>设为默认地址
                </li>
                <li>
                    <label for="">&nbsp;</label>
