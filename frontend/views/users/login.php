        ...
        <div class="topnav_right fr">
            <ul>
                <?php if (!Yii::$app->user->isGuest): ?>
                    ...
                    <li><?= Yii::$app->user->identity->username ?>您好，欢迎来到京西！[<a href="login.html">登录</a>] [<a
...
<div class="login w990 bc mt10">
    ...
    <div class="login_bd">
        <div class="login_form fl">
            <form action="<?= \yii\helpers\Url::to(['users/login']) ?>" method="post" id="signupForm">
                <ul>
                    <li>
                        <label for="">用户名：</label>
                    ...
                    <li class="checkcode">
                        ...
                        <span>看不清？<a href="javascripts:;" id="change_captcha">换一张</a></span>
                    </li>
                    <li>
                        <label for="">&nbsp;</label>
