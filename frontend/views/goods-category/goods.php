...
<div class="main w1210 mt10 bc">
    ...
    <div class="goods_content fl mt10 ml10">
        <!-- 商品概要信息 start -->
        <div class="summary">
            <h3><strong><?= $goodList->name ?></strong></h3>

            <!-- 图片预览区域 start -->
            <div class="preview fl">
                <div class="midpic">
                    <a href="<?= "http://admin.yiishop.com" . $goodList->logo ?>" class="jqzoom" rel="gal1">
                        <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
                        <img src="<?= "http://admin.yiishop.com" . $goodList->logo ?>" alt=""/>
                        <!-- 第一幅图片的中图 -->
                    </a>
                </div>
                                ...
                                <?php if ($k == 0): ?>
                                    <li class="cur">
                                        ...
                                        <a class="zoomThumbActive" href="javascript:void(0);"
                                           rel="{gallery: 'gal1', smallimage: '<?= "http://admin.yiishop.com" . $m->path ?>',largeimage: '<?= "http://admin.yiishop.com" . $m->path ?>'}"><img
                                                    src="<?= "http://admin.yiishop.com" . $m->path ?>"></a>
                                    </li>
                                <?php endif; ?>
                                <?php if ($k != 0): ?>
                                    <li>
            ...
            <div class="goodsinfo fl ml10">
                ...
                <ul>
                    <li><span>商品编号： </span><?= $goodList->sn ?></li>
                    <li class="market_price"><span>定价：</span><em><?= $goodList->market_price ?></em></li>
                    <li class="shop_price"><span>本店价：</span> <strong><?= $goodList->shop_price ?></strong> <a href="">(降价通知)</a>
                    </li>
                    <li><span>上架时间：</span><?= date('Y-m-d', $goodList->create_time) ?></li>
                ...
                <form action="<?= \yii\helpers\Url::to(['goods-category/add-to-cart']) ?>" method="get" class="choose">
                    <ul>
                        ...
                        <li>
                            <dl>
                                ...
                                <dd>
                                    ...
                                    <input type="hidden" name="goods_id" value="<?= $goodList->id ?>" />
